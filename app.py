...
@app.route('/completar/<int:tarea_id>', methods=['POST'])  # ← CAMBIADO A POST
...
if __name__ == '__main__':
    ...
    #db_manager ya ejecuta crear_tablas()
    # Si se requiere ejecutariamos directamente el metodo
    # previamente:from src.database import DBManager, crear_tablas
    # crear_tablas()  # ← Función, no método
